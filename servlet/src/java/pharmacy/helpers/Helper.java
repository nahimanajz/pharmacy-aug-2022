...
public class Helper {
    ...
    public boolean checkCredentials(UserModel loopedUser, UserModel clientUser) {
        ...
        switch (this.toLower(role)) {
            ...
            case "physician":
                return this.toLower(loopedUser.getEmail()).equals(this.toLower(clientUser.getEmail()))
                        && loopedUser.getPassword().equals(clientUser.getPassword());
            case "pharmacist":
                return this.toLower(loopedUser.getPhoneNumber()).equals(this.toLower(clientUser.getPhoneNumber()))
                        && loopedUser.getPassword().equals(clientUser.getPassword());
            default:
                return false;
        }
